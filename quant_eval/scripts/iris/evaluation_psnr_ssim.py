...
def main(fake_dir, real_dir, experiment):
    ...
    psnr_table.to_csv('GANs_Research/my_imps/research_models/v3/evaluation/Iris/%s/psnr.csv' % (experiment))
    ...
    # Make sure path is right - this is for Iris
    ssim_table.to_csv('GANs_Research/my_imps/research_models/v3/evaluation/Iris/%s/ssim.csv' % (experiment))
