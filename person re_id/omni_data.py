...
class Faces(ImageDataset): #class Faces
    ...
    def __init__(self, root='', **kwargs): #(, **kwargs)
        ...
        self.train_dir = osp.join(self.dataset_dir, 'omni_reid', 'train') #reid-data/omni/omni-reid/train
        self.query_dir = osp.join(self.dataset_dir, 'omni_reid', 'probe') #reid-data/omni/omni-reid/probe
        self.gallery_dir = osp.join(self.dataset_dir, 'omni_reid', 'gallery') #reid-data/omni/omni-reid/gallery
