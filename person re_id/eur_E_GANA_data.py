...
class Faces(ImageDataset): #class Faces
    ...
    def __init__(self, root='', **kwargs): #(, **kwargs)
        ...
        self.train_dir = osp.join(self.dataset_dir, 'e_gana', 'train') #reid-data/omni/omni-reid/train
        self.query_dir = osp.join(self.dataset_dir, 'e_gana', 'probe') #reid-data/omni/omni-reid/probe
        self.gallery_dir = osp.join(self.dataset_dir, 'e_gana', 'gallery') #reid-data/omni/omni-reid/gallery
