...
eg. "/home/local/AD/cordun1/experiments/pix2pix_mods_label_loss/saved_models/exp_c2/eurecom_adas_iris/generator_490.pth"
...
for i, batch in enumerate(test_dataloader):
    ...
    save_image(img_sample, "/home/local/AD/cordun1/experiments/pix2pix_mods_label_loss/images/test_results/%s/%s.png" % (opt.experiment, i), nrow=5, normalize=True)
