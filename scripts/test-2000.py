...
#generator.load_state_dict(torch.load("/home/local/AD/cordun1/experiments/pix2pix_mods_label_loss/saved_models/%s/generator_490.pth" % (opt.dataset_name)))

# for V3, every 100 epochs are saved; it starts with generator_0, which is the 1st epoch; hence generator_1990 is the 2000'th
generator.load_state_dict(torch.load("/home/local/AD/cordun1/experiments/pix2pix_mods_label_loss/saved_models/%s/generator_1900.pth" % (opt.experiment)))
#generator.load_state_dict(torch.load("/home/local/AD/cordun1/experiments/pix2pix_mods_label_loss/saved_models/%s/generator_1990.pth" % (opt.experiment)))
...
test_dataloader = DataLoader(
    TestImageDataset(root = "/home/local/AD/cordun1/experiments/data/%s" % opt.dataset_name,
        ...
        annots_csv = "/home/local/AD/cordun1/experiments/data/labels/{}.csv".format(opt.labels_csv),
        mode="test"),
    batch_size=1,
...
for i, batch in enumerate(test_dataloader):
    ...
    save_image(img_sample, "/home/local/AD/cordun1/experiments/pix2pix_mods_label_loss/images/test_results/%s/%s.png" % (opt.long_dir, i), nrow=5, normalize=True)
