...
class Faces(ImageDataset): #class Faces
    ...
    def __init__(self, root='', **kwargs): #(, **kwargs)
        ...
        self.train_dir = osp.join(self.dataset_dir, 'ei_gand', 'train') #reid-data/omni/omni-reid/train
        self.query_dir = osp.join(self.dataset_dir, 'ei_gand', 'probe') #reid-data/omni/omni-reid/probe
        self.gallery_dir = osp.join(self.dataset_dir, 'ei_gand', 'gallery') #reid-data/omni/omni-reid/gallery
